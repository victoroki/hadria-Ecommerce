...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware(['auth:admin'])->group(function () {
        ...
        Route::controller(ProductController::class)->group(function () {
            ...
            Route::get('/product/change/status/{id}', [ProductController::class, 'update_status'])->name('admin.product.change.status');
            Route::post('/product/sub/category', [ProductController::class, 'get_sub_category'])->name('admin.product.get.sub-category');
            Route::post('/product/child/category', [ProductController::class, 'get_child_category'])->name('admin.product.get.child-category');
