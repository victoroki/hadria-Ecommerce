        ...
        <div class="col-xl-9 col-lg-8">
                            ...
                            <div class="payment-methods">
                                <div class="single-payment-method">
                                    <a class="text-decoration-none" href="#" data-bs-toggle="modal" data-bs-target="#stripe">
                                        <img class="" src="https://geniusdevs.com/codecanyon/omnimart40/assets/images/1601930611stripe-logo-blue.png" alt="Stripe" title="Stripe">
                                        <p>Stripe</p>
                                    </a>
                                </div>
                                <div class="single-payment-method">
                                    <a class="text-decoration-none" href="#" data-bs-toggle="modal" data-bs-target="#bank">
                                        <img class="" src="https://geniusdevs.com/codecanyon/omnimart40/assets/images/1638530860pngwing.com (1).png" alt="Bank Transfer" title="Bank Transfer">
                                        <p>Bank Transfer</p>
                                    </a>
                                </div>
                                <div class="single-payment-method">
                                    <a class="text-decoration-none" href="#" data-bs-toggle="modal" data-bs-target="#cod">
                                        <img class="" src="https://support.sitegiant.com/wp-content/uploads/2022/08/cash-on-delivery-banner.png" alt="Cash on Delivery" title="Cash on Delivery">
                                        <p>Cash on Delivery</p>
                                    </a>
                                </div>
                                <div class="single-payment-method">
                                    <a class="text-decoration-none" href="#" data-bs-toggle="modal" data-bs-target="#mpesa">
                                        <img class="" src="path/to/mpesa-logo.png" alt="MPesa" title="MPesa">
                                        <p>MPesa</p>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="card-body">
                                ...
                                <form role="form" action="{{ route('user.checkout.stripe') }}" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" id="payment-form">
                                    @csrf
                                    <div class="form-group col-sm-12">
                                        <input class="form-control card-number" type="text" name="card" placeholder="Card Number" required>
                                    </div>
                                    <input type="hidden" name="payment_method" value="Stripe">
                                    <div class="form-group col-sm-12">
                                        <input class="form-control card-expiry-month" type="text" name="month" placeholder="Expiration Month" required>
                                    </div>
                                    <div class="form-group col-sm-12">
                                        <input class="form-control card-expiry-year" type="text" name="year" placeholder="Expiration Year" required>
                                    </div>
                                    <div class="form-group col-sm-12">
                                    ...
                                    <div class="modal-footer">
                                        <button class="btn btn-primary btn-sm" type="button" data-bs-dismiss="modal"><span>Cancel</span></button>
                                        <button class="btn btn-primary btn-sm" type="submit"><span>Checkout With Stripe</span></button>
                                    </form>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal fade" id="mpesa" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="modal-title">Transactions via MPesa</h6>
                        ...
                        <form action="" method="POST">
                            @csrf
                            <input type="hidden" name="payment_method" value="MPesa" id="">
                            <div class="modal-body">
                                <div class="card-body">
                                    <p>MPesa is a mobile payment solution that allows you to pay directly from your mobile phone. Please enter your phone number and the amount to proceed with the payment.</p>
                                    <div class="form-group col-sm-12">
                                        <label for="phone_number">Phone Number</label>
                                        <input class="form-control" type="text" id="phone_number" name="phone_number" placeholder="Enter your MPesa registered phone number" required>
                                    </div>
                                    <div class="form-group col-sm-12">
                            ...
                            <div class="modal-footer">
                                <button class="btn btn-primary btn-sm" type="button" data-bs-dismiss="modal"><span>Cancel</span></button>
                                <button class="btn btn-primary btn-sm" type="submit"><span>Checkout with MPesa</span></button>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <form action="{{ route('user.checkout.bank.transfer') }}" method="POST">
                            ...
                            <div class="modal-body">
                                <div class="col-lg-12 form-group">
                                    ...
                                    <input class="form-control" name="transaction" id="transaction" placeholder="Enter Your Transaction Number" required>
                                </div>
